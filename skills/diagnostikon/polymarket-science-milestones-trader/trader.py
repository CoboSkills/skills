...
Trades Polymarket prediction markets on scientific breakthroughs, Nobel Prizes, physics discoveries, climate science milestones, and research paper impact.
...
KEYWORDS = ['Nobel Prize', 'physics', 'fusion energy', 'ITER', 'nuclear fusion', 'dark matter', 'quantum computer', 'breakthrough', 'nature paper', 'CERN', 'James Webb', 'room temperature superconductor', 'AGI', 'consciousness', 'cancer cure', 'Alzheimer treatment', 'longevity', 'aging reversal', 'CRISPR', 'gene therapy']
...
def run(live: bool = False) -> None:
    ...
    print(f"[polymarket-science-milestones-trader] mode={mode} max_pos=${MAX_POSITION} min_vol=${MIN_VOLUME} max_spread={MAX_SPREAD:.0%} min_days={MIN_DAYS}")
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="Trades Polymarket prediction markets on scientific breakthroughs, Nobel Prizes, physics discoveries, climate science milestones, and research paper impact.")
