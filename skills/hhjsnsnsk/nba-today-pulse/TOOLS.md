...
This public bundle returns timezone-aware NBA daily status, compact same-day stats, dedicated pregame/live/post views, and independent injury reports through one bundled command wrapper. The `1.0.11` release keeps the compact day/live output, adds the faster day fast path, and hardens refresh-safe follow-up handling.
