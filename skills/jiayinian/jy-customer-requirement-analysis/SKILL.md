...
mcporter call jy-financedata-tool.FundMultipleFactorFilter query="稳健型债券基金 年化收益 4% 以上"
...
mcporter call jy-financedata-tool.StockMultipleFactorFilter query="市盈率低于 20 的科技股"
...
```bash
mcporter call jy-financedata-tool.FundMultipleFactorFilter query="平衡型混合基金 近 3 年收益排名前 20 规模大于 10 亿"
mcporter call jy-financedata-tool.FundMultipleFactorFilter query="稳健型债券基金 近 1 年收益大于 3%"
mcporter call jy-financedata-tool.FundMultipleFactorFilter query="成长型股票基金 近 3 年收益排名前 20"
```
...
| `FundMultipleFactorFilter` | 筛选基金 | `mcporter call jy-financedata-tool.FundMultipleFactorFilter query="稳健型债券基金 年化收益 4% 以上"` |
| `StockMultipleFactorFilter` | 选股 | `mcporter call jy-financedata-tool.StockMultipleFactorFilter query="市盈率低于 20 的科技股"` |
