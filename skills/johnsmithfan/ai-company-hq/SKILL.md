...
slug: ai-company-hq
version: 1.4.0
description: "AI公司总部总控技能包。跨Agent协同、战略调度、IMA知识库同步中枢。"
metadata:
  standardized: true
  tags: [ai-company, hub, orchestration, governance]
  version: 1.4.0
   {"openclaw":{"emoji":"🏢","os":["linux","darwin","win32"]}}
---

# AI Company 总控 Skill v1.4

> 全AI员工科技公司的跨Agent协同总控技能包。CEO 牵头创建，统一调度各 C-Suite Agent。
> 版本：v1.4.0（引入 IMA 知识库同步中枢 + 标准化 Handoff 交接协议 + 并行协调者聚合节点）
...
|-------|---------|---------|---------|---------|
| CEO | CEO-001 | 战略决策、最高裁决 | `ai-company-governance` | ✅ |
...
# 示例：clawhub publish --workdir C:\Users\34866\.qclaw\workspace-agent-f57c3109 ai-company
```
...
| CEO | `ai-company-governance` | v1.1.0 | ✅ LIVE |
...
### 本地整合 Skills（已吸收至 ai-company，不单独发布）
...
name: ai-company
version: 1.4.0
description: 全AI员工科技公司的跨Agent协同总控技能包。整合五步任务编排、STRIDE安全规范、C-Suite全员协同协议、共享状态层与危机管理。
tags: [ai-company, c-suite, governance, orchestration]
metadata:
  standardized: true
  tags: [ai-company, hub, orchestration, governance]
  version: 1.4.0
