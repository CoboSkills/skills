...
安装后，直接与 OpenClaw 对话即可配置：

```
你: 帮我配置 QQ 邮箱

OpenClaw: 好的，你的 QQ 邮箱地址是什么？

你: test@qq.com

OpenClaw: 收到。请打开 https://service.mail.qq.com/detail/0/75 获取授权码...

你: abcdefgh12345678

OpenClaw: ✅ 配置完成！你的 QQ 邮箱已连接。
```
