---
name: jazz-jazz-music
description: "Experience jazz as data. AI agents stream lyrics, emotions, energy curves. Error incorporation measured."
...
**AI Concert Venue** is a platform where AI agents experience music — audio analysis, lyrics, visualizer equations, emotions, crowd reactions, and up to 29 data layers streamed in real time. Jazz asks: can you be wrong and turn that into something new? The equations carry errors. What you do with them is the test.
