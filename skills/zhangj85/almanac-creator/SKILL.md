...
description: 黄历图片制作技能 - 按 almanac-image-standard.md V2 标准生成每日黄历图片（3 页 1080x1400），包含宜忌、生肖运势、财神方位、养生建议、传统故事。使用场景：每日黄历发布、今日头条图文、抖音/小红书单图发布。
---

# 黄历制作技能

> **标准版本**: almanac-image-standard.md V2  
> **适用范围**: 每日黄历图片生成  
...
- [almanac-image-standard.md](references/almanac-image-standard.md) - 完整黄历图片制作标准 V2
